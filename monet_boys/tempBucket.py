...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '../raw_data/batch-672-gan-monet-59f43b305ef6.json'
...
def dowload_from_bucket(blob_name, file_path, bucket_name):
...
def main():
    dowload_from_bucket('test_monet',os.path.join(file_path,'download1.jpg'), bucket_name)
